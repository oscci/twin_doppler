...
myfileloc<-"C:/Users/dbishop/Dropbox/R/DB_otherscripts/doppler/" #directory for files
...
#------------------------------------------------------------------------
filelist <- read.xlsx("Twins Doppler_trials for inclusion based on behaviour1",sheetName="Sheet1")
...
########################################################################
mysub=33 #select file here or have loop
########################################################################
...
wantcols=c(2,3,4,8) #csec, L, R, marker #select columns of interest and put in shortdat
...
#number specified here is max number of bad trials corrected for
